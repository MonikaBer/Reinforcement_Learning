...
def run():
    envName = 'Assault-v4'
    display = utils.display.createDisplay()
    env = utils.env.createEnv(envName)
    ...
    '''
    server, address = utils.server.createServer()
